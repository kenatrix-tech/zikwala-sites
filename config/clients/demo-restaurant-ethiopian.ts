...
export const config: SiteConfig = {
  business: {
    ...
    city: "Falls Church",
    state: "VA",
    logo: "/clients/demo-restaurant-ethiopian/logo.png",
    niche: "restaurant",
  },
  ...
  seo: {
    ...
    ogImage: "/clients/demo-restaurant-ethiopian/og.png",
  },
  ...
  hero: {
    ...
    image: "/clients/demo-restaurant-ethiopian/hero.jpg",
  ...
  products: {
    ...
    items: [
      // ── Meat Dishes ───────────────────────────────────────────
      {
        ...
        price: 22,
        image: "/clients/demo-restaurant-ethiopian/menu/doro-wat.jpg",
      ...
      },
      {
        ...
        price: 24,
        image: "/clients/demo-restaurant-ethiopian/menu/lamb-tibs.jpg",
        category: "Meat Dishes",
        badge: "Chef's Pick",
      },
      {
        ...
        price: 22,
        image: "/clients/demo-restaurant-ethiopian/menu/kitfo.jpg",
        category: "Meat Dishes",
      },
      {
        id: "beef-tibs",
        ...
        price: 20,
        image: "/clients/demo-restaurant-ethiopian/menu/beef-tibs.jpg",
        category: "Meat Dishes",
      },
      ...
      // ── Vegetarian / Fasting ──────────────────────────────────
      {
        ...
        price: 16,
        image: "/clients/demo-restaurant-ethiopian/menu/misir-wat.jpg",
        category: "Vegetarian",
        badge: "Vegan",
      },
      {
        ...
        price: 15,
        image: "/clients/demo-restaurant-ethiopian/menu/shiro.jpg",
        category: "Vegetarian",
        badge: "Vegan",
      },
      {
        ...
        price: 14,
        image: "/clients/demo-restaurant-ethiopian/menu/gomen.jpg",
        category: "Vegetarian",
        badge: "Vegan",
      },
      ...
      // ── Combo Platters ────────────────────────────────────────
      {
        ...
        price: 48,
        image: "/clients/demo-restaurant-ethiopian/menu/nazret-special.jpg",
      ...
      },
      {
        ...
        price: 28,
        image: "/clients/demo-restaurant-ethiopian/menu/beyaynetu.jpg",
        category: "Combo Platters",
      },
      ...
      // ── Drinks & Coffee ───────────────────────────────────────
      {
        ...
        price: 12,
        image: "/clients/demo-restaurant-ethiopian/menu/buna.jpg",
        category: "Drinks",
        badge: "Signature",
      },
      {
        ...
        price: 10,
        image: "/clients/demo-restaurant-ethiopian/menu/tej.jpg",
        category: "Drinks",
      },
    ],
  },
  ...
  gallery: {
    ...
    images: [
      { src: "/clients/demo-restaurant-ethiopian/gallery/1.jpg", alt: "Injera platter with stews",       badge: "Family Style" },
      { src: "/clients/demo-restaurant-ethiopian/gallery/2.jpg", alt: "Restaurant interior with decor" },
      { src: "/clients/demo-restaurant-ethiopian/gallery/3.jpg", alt: "Ethiopian coffee ceremony",       badge: "Coffee Ceremony" },
      { src: "/clients/demo-restaurant-ethiopian/gallery/4.jpg", alt: "Doro Wat close-up" },
      { src: "/clients/demo-restaurant-ethiopian/gallery/5.jpg", alt: "Traditional Ethiopian spices",    badge: "Authentic Spices" },
      { src: "/clients/demo-restaurant-ethiopian/gallery/6.jpg", alt: "Group dining family-style" },
    ],
  },
  ...
  about: {
    ...
    image: "/clients/demo-restaurant-ethiopian/about.jpg",
    highlights: [
