...
if $SKIP_BUILD; then
  ...
  echo "── Generating active-client config for: $CLIENT_ID"
  printf "// Auto-generated by deploy.sh — do not edit manually.\nexport { config } from './clients/%s'\n" "$CLIENT_ID" > config/active-client.ts
  echo "✓  config/active-client.ts → $CLIENT_ID"
  echo ""
  echo "── Building..."
