          ...
          <div className="lg:col-span-3">
            {sent ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-brand text-on-primary font-semibold py-4 rounded-xl hover:opacity-90 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-base"
                >
                  <Send size={18} />
                  Send Message
                </button>
