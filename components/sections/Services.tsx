import { ArrowRight, Home, Building2, Sparkles, HardHat, Globe, Briefcase, Heart,
  ...
  Cake, Coffee, Scissors, Eye, Camera, GraduationCap, Baby, Crown, Gift,
          ...
          {services.items.map((service, index) => {
            ...
            return (
              <AnimateIn key={service.name} delay={index * 100}>
                <div className="group bg-white dark:bg-gray-800 rounded-2xl p-7 shadow-sm border border-gray-100 dark:border-gray-700 card-hover cursor-default h-full">
                  {/* Icon */}
                  <div
